      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-16 text-center">
          ...
          <p className="mx-auto max-w-2xl text-lg text-muted-foreground">
            Powerful SaaS products designed to streamline workflows, enhance operations, and leverage AI for content creation.
          </p>
        </div>
            ...
            <GlassCard key={solution.key} className="group h-full overflow-hidden p-0 flex flex-col">
              ...
              <div className="flex flex-1 flex-col p-6">
                ...
                <div className="mb-3 flex items-center justify-between gap-3">
                  <h3 className="text-xl font-semibold capitalize text-foreground">{solution.key}</h3>
                ...
                <div className="mt-auto flex gap-3">
                  ...
                  <Button className="flex-1 glass" size="lg">
